...
namespace XafFromXpoToEf.Module;

// For more typical usage scenarios, be sure to check out https://docs.devexpress.com/eXpressAppFramework/DevExpress.ExpressApp.ModuleBase.
public sealed class XafFromXpoToEfModule : ModuleBase {
    public XafFromXpoToEfModule() {
		// 
		// XafFromXpoToEfModule
		// 
		AdditionalExportedTypes.Add(typeof(XafFromXpoToEf.Module.BusinessObjects.ApplicationUser));
